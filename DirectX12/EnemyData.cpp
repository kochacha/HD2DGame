...
{
    //ここにエネミーのデータを登録していく
    AddEnemyParam(NIHUTERIZA, "nihuteriza", TYPE_DARK, SMALL_ENEMY_SIZE, 1, 10, 10, 5, 5, 15, 5, 5, 5, 5, 50, 5, 5);
    AddEnemyParam(BABYDORAGON, "babydoragon", TYPE_FIRE, SMALL_ENEMY_SIZE, 1, 10, 10, 5, 5, 20, 5, 5, 5, 5, 50, 5, 5);
}